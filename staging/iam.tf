...
data "aws_iam_policy_document" "amazon_data_firehose" {
  ...
  statement {
    ...
    resources = [
      ...
      "${aws_cloudwatch_log_stream.lambda_functions[aws_lambda_function.lambda_metric_alarm.function_name].arn}:*",
      aws_cloudwatch_log_stream.lambda_functions[aws_lambda_function.poke_api.function_name].arn,
      "${aws_cloudwatch_log_stream.lambda_functions[aws_lambda_function.poke_api.function_name].arn}:*",
      aws_cloudwatch_log_stream.lambda_functions[aws_lambda_function.response_api.function_name].arn,
      "${aws_cloudwatch_log_stream.lambda_functions[aws_lambda_function.response_api.function_name].arn}:*",
      aws_cloudwatch_log_stream.bedrock_knowledge_base["knowledge-bases"].arn,
      "${aws_cloudwatch_log_stream.bedrock_knowledge_base["knowledge-bases"].arn}:*",
...
data "aws_iam_policy_document" "cloudwatch_logs_to_amazon_data_firehose" {
  ...
  statement {
    ...
    resources = [
      ...
      aws_cloudwatch_log_group.lambda_functions[aws_lambda_function.poke_api.function_name].arn,
      aws_cloudwatch_log_group.lambda_functions[aws_lambda_function.response_api.function_name].arn,
      aws_cloudwatch_log_group.lambda_functions[aws_lambda_function.lambda_log_error_alert.function_name].arn,
      aws_cloudwatch_log_group.lambda_functions[aws_lambda_function.lambda_metric_alarm.function_name].arn,
      aws_cloudwatch_log_group.bedrock_knowledge_base["knowledge-bases"].arn,
